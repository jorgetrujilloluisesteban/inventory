...
Route::Post('insertemployee', 'App\Http\Controllers\Api\EmployeeController@store');
Route::Get('showemployee', 'App\Http\Controllers\Api\EmployeeController@index');
//Route::post('Cart/delete/{idcar}/{idpro}','App\Http\Controllers\CartController@delete');
Route::delete('deleteemployee/{id}', 'App\Http\Controllers\Api\EmployeeController@destroy');
Route::Get('employee/{id}', 'App\Http\Controllers\Api\EmployeeController@show');
Route::Post('updateemployee/{id}', 'App\Http\Controllers\Api\EmployeeController@update');
